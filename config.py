WISE_XMATCH_FILE = 'Datasets/WISE_X-match_Vlit.fits'
GLEAM_FILE = 'Datasets/GLEAM_WISE_20asec_v3.fits'

JMFIT_AX_FILE = 'Datasets/JMFIT_CASA_A_results.csv'
JMFIT_BX_FILE = 'Datasets/JMFIT_CASA_B_results.csv'
